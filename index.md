...
<a name="events"></a>
<h1 class="anchor-point">{{site.band_title}} will be playing music at these events</h1>
{% include events.html %}

<a name="listen"></a>
<h1 class="anchor-point">Listen to {{site.band_title}}</h1>
{% include listen.html %}

<a name="photos"></a>
<h1 class="anchor-point">Photos of {{site.band_title}}</h1>
{% include photos.html %}

<a name="who"></a>
<h1 class="anchor-point">{{site.band_title}} Band Members</h1>
{% include members.html %}

<a name="contact"></a>
<h1 class="anchor-point">{{site.band_title}} Contact</h1>
